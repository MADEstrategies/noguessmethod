        ...
        <main className="auth signup-layout">
          <section className="card auth-panel signup-panel">
            ...
            <div style={{ marginTop: 28 }}>
              <Link to="/login" className="btn primary signup-cta" style={{ display: 'flex', justifyContent: 'center' }}>
                Go to Login →
              </Link>
            </div>
          </section>
            ...
            >
              ...
              {step === 0 && (
                <>
                  ...
                  <div className="signup-actions" style={{ marginTop: 22 }}>
                    <button className="primary signup-cta" onClick={advance}>
              ...
              {step === 1 && (
                <>
                  ...
                  <div className="signup-actions">
                    <button className="signup-back" onClick={back}>← Back</button>
                    <button className="primary signup-cta" onClick={advance}>Continue →</button>
                  </div>
                </>
              )}
              ...
              {step === 3 && (
                <>
                  ...
                  <div className="signup-actions">
                    <button className="signup-back" onClick={back}>← Back</button>
                    <button className="primary signup-cta" onClick={handleSubmit} disabled={loading}>
